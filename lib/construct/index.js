 ...
 * @api public
 */
Constructor.prototype.build = function build({ promote, data }, done) {
 ...
 * @api public
 */
Constructor.prototype.prepare = function prepare(spec, content, statusWriter, next) {
  const app = this.app;
 ...
 * @param   {Function} next - go to the next step and run builds
 */
Constructor.prototype.repack = function repack(spec, content, paths, statusWriter, next) {
 ...
 * @api public
 */
Constructor.prototype.install = function install(spec, installPath, statusWriter, fn) {
  const pkgDir = path.join(installPath, 'package');
