 ...
 */
BuildQuery.prototype.order = function order(heads) {
 ...
 */
BuildQuery.prototype.missing = function () {
 ...
 */
BuildQuery.prototype.specify = function specify(head) {
  return new Spec(
    head.name,
    head.env,
    this.latest,
